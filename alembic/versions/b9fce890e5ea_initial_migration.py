...
def upgrade() -> None:
    ...
    sa.Column('account_type', sa.Enum('SAVINGS', 'CHECKING', 'BUSINESS', 'LOAN', 'CREDIT', name='accounttype'), nullable=False),
    ...
    sa.Column('card_type', sa.Enum('DEBIT', 'CREDIT', 'PREPAID', name='cardtype'), nullable=False),
    sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', 'LOST', 'STOLEN', 'EXPIRED', 'BLOCKED', name='cardstatus'), nullable=False),
    ...
    sa.Column('transaction_type', sa.Enum('DEPOSIT', 'WITHDRAWAL', 'TRANSFER', 'PAYMENT', 'REFUND', 'FEE', name='transactiontype'), nullable=False),
    sa.Column('status', sa.Enum('PENDING', 'COMPLETED', 'FAILED', 'CANCELLED', 'REVERSED', name='transactionstatus'), nullable=False),
