...
async def create_account(db: AsyncSession, user_id: int, account_data: AccountCreate) -> Account:
...
async def update_account_balance(db: AsyncSession, account_id: int, amount: float) -> Account:
...
async def update_account_status(db: AsyncSession, account_id: int, status: str) -> Account:
